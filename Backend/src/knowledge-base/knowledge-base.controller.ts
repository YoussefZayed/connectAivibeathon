...
export class KnowledgeBaseController {
  ...
  async createKnowledgeBaseEntry() {
    return tsRestHandler(knowledgeBaseContract.createKnowledgeBaseEntry, {
      async handler({ body }) {
        try {
  ...
  async getKnowledgeBaseEntries() {
    return tsRestHandler(knowledgeBaseContract.getKnowledgeBaseEntries, {
  ...
  async getKnowledgeBaseEntry() {
    return tsRestHandler(knowledgeBaseContract.getKnowledgeBaseEntry, {
      async handler({ params }) {
        try {
  ...
  async queryKnowledge() {
    return tsRestHandler(knowledgeBaseContract.queryKnowledge, {
      async handler({ body }) {
        try {
